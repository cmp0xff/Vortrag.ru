...
\section{The Dirac quantisation and the self-adjointness}
...
\end{align}
in which $E \coloneqq \hslash^2 k_\beta^2 / 12 \varkappa^{1/2} \ge 0$,
$\mitsansM_\text{P} \coloneqq \varkappa^{-1/2}$,
$x \coloneqq \varkappa \chi$, and
$\widetilde{V} \coloneqq \varkappa^{3/2} \vbr{V}$.
