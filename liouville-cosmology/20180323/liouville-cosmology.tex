...
$\widehat{H}_\text{eff}$ is bounded below; generalised eigenfunctions are
the Besselian $\BesselK_{\ii \nu}$'s.
...
\item In addition to symmetricity $\rbr{H^\dagger \phi_1, \phi_2} \equiv
...
\supset \rfun{\mathrm{Dom}_0}{H}$ in general.
