...
$\rfun{\mathrm{Dom}}{H} \subsetneq \mscrF$\footfullcite[ch.~9]{hall2013}.
...
{Results for the special Morse potential \footfullcite[sec.~8.5]{Gitman2012}}
\begin{itemize}
\item For the quintessence model $\rbr{+, +}$: $\widehat{H}_\text{eff}$ is
\textcolor{blue}{essentially self-adjoint} on
$\rfun{C_\text{c}^{\infty}}{\BbbR}$\footfullcite[See also][sec.~9.9]{hall2013}.
...
\sin \frac{\pp\rbr{\mu-\nu}}{2}$;
%were $\widehat{H}_{\text{eff}}$ symmetric for the $\BesselJ_{\nu}$'s, the right
%hand side would be zero.
