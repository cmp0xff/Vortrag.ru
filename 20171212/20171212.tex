...
constant\footfullcite{COPELAND2006,Bamba2012}, but its origin has yet to be
understood.

\item Proposals have been made of quintessence\footfullcite{Caldwell1998} and 
phantom\footfullcite{Caldwell2002} matter, with barotropic 
index\footnote{Barotropic index is the $w$ in equation of state $\rho = wp$.} 
$-1 < w < -1/3$ and $w < -1$, respectively.
...
\item Call $\beta$ the ``temporal'' variable, $\chi$ the ``spacial'' variable
