...
\end{itemize}
\begin{itemize}
\item It can be shown\footfullcite{Mostafazadeh2006} that the density
\begin{align}
...
\item One can choose a Poissonian amplitude
\begin{align}
\rfun{A_n}{\overline{n}} \coloneqq
\rbr{\ee^{-\overline{n}}\frac{\overline{n}^n}{n!}}^{1/2}
\end{align}
\item In \footfullcite{Kiefer1990}, $\rfun{A_n}{\overline{n}/\sqrt{2}}$ was chosen
