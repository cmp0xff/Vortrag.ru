...
constant\footfullcite{COPELAND2006,Bamba2012} as stationary Dark Energy, but its origin has yet to be understood.

\item Dynamical Dark Energy has been modeled by
quintessence\footfullcite{Caldwell1998} and phantom\footfullcite{Caldwell2002} matter, with barotropic index\footnote{Barotropic index is the $w$ in equation
...
opeator\footfullcite[ch.\ 8]{Kiefer2012}, one 
...
\item In terms of a Klein--Gordon equation, call $\beta$ the ``temporal'' variable, and $\chi$ the ``spacial'' variable.

\item A common starting point is the \emph{Schrödinger product}\footfullcite[ch.\ 5]{Kiefer2012}
\begin{align}
